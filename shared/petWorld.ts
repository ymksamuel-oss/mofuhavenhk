...
export const catBreedGuides: CatBreedGuide[] = [
  {
    name: "英國短毛貓",
    image: "/assets/pet/british-01.jpg",
    images: [
      "/assets/pet/british-01.jpg",
      "/assets/pet/british-02.jpg",
      "/assets/pet/british-03.jpg",
      "/assets/pet/british-04.jpg",
      "/assets/pet/british-05.jpg",
      "/assets/pet/british-06.jpg",
    ],
    temperament: "穩重、親人而不過分黏人",
    care: "短毛仍需要定期梳理，並安排溫和的互動遊戲。",
    note: "圓潤體型適合以玩耍及均衡份量維持日常活動。",
    isRealPhoto: true,
    photoCredit: "六張真實照片：George E. Koronaios、Nickolas Titkov、Nicholas Gemini／Wikimedia Commons · CC BY-SA 2.0／4.0",
  },
  {
    name: "美國短毛貓",
    image: "/assets/pet/american-01.jpg",
    images: [
      "/assets/pet/american-01.jpg",
      "/assets/pet/american-02.jpg",
      "/assets/pet/american-03.jpg",
      "/assets/pet/american-04.jpg",
      "/assets/pet/american-05.jpg",
      "/assets/pet/american-06.jpg",
    ],
    temperament: "活潑、適應力強、喜歡探索",
    care: "準備攀爬、追逐及益智玩具，讓牠每天都有消耗精力的機會。",
    note: "對新環境通常較有彈性，但仍應循序漸進介紹新事物。",
    isRealPhoto: true,
    photoCredit: "六張真實照片：Dustin Warrington、Pluckhorizon47、Darron Birgenheier、Luke12345678901、Crispybeatle、Nickolas Titkov／Wikimedia Commons · CC0／CC BY-SA 2.0／4.0",
  },
  {
    name: "布偶貓",
    image: "/assets/pet/ragdoll-01.jpg",
    images: [
      "/assets/pet/ragdoll-01.jpg",
      "/assets/pet/ragdoll-02.jpg",
      "/assets/pet/ragdoll-03.jpg",
      "/assets/pet/ragdoll-04.jpg",
      "/assets/pet/ragdoll-05.jpg",
      "/assets/pet/ragdoll-06.jpg",
    ],
    temperament: "溫柔、安靜、喜歡陪伴",
    care: "半長毛需要固定梳理，並留意打結及居家活動空間。",
    note: "抱起或互動時應托好身體，讓牠保持安全與放鬆。",
    isRealPhoto: true,
    photoCredit: "六張真實照片：Simone Johnsson、Cássia Afini、Kadı、MOZZILAND、Kryštof Jelínek、Arjunmz／Wikimedia Commons · CC0／CC BY 2.0／4.0／CC BY-SA 2.0／4.0",
  },
  {
    name: "暹羅貓",
