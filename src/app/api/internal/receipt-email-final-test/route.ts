...
const TEST_TOKEN_HASH = "4b6e5be8e59d97931348e81cb7a93a1b3ede4932c75364b44d37e8e18bc362e7";
const TEST_EXPIRES_AT = Date.parse("2026-08-27T09:15:28Z");
const TEST_PAYMENT_INTENT_ID = "pi_mofu_receipt_final_test_20260827_001";
const TEST_ORDER_NUMBER = "TEST-EMAIL-NO-CHARGE-20260827-FINAL";
...
export async function POST(request: NextRequest) {
  ...
  const result = await sendOrderReceiptEmail(TEST_PAYMENT_INTENT_ID, {
    ...
    shippingAddress: "此為經授權的電子收據送達測試，並非真實送貨地址。",
    paidAt: new Date(),
    paymentLabel: "系統送達測試（未經 Stripe 付款）",
    subtotalHkd: 1,
    shippingHkd: 0,
    totalHkd: 1,
    items: [
