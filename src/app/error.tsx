...
export default function Error({
  ...
  return (
    <div style={{ padding: "60px 20px", textAlign: "center", fontFamily: "sans-serif" }}>
      <h2 style={{ fontSize: "20px", fontWeight: "bold", marginBottom: "8px", color: "#54392D" }}>Mofu Haven HK 系統提示</h2>
      <p style={{ color: "#756962", marginBottom: "16px", fontSize: "14px" }}>頁面載入時發生暫時性問題。</p>
      <button
        type="button"
        onClick={() => reset()}
