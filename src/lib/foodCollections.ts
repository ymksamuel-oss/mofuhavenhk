...
export const FOOD_COLLECTIONS: FoodCollectionDef[] = [
  ...
  },
  {
    ...
    wtHandle: "狗狗小食",
    origin: "wt-japan",
    note: "Reuse WT 狗狗小食 — general non-freeze dog treats",
  },
  {
    key: "狗餅",
    parentSlug: "dogs",
    pathSlug: "dog-biscuits",
    wtHandle: "餅乾類",
    origin: "wt-japan",
    note: "Reuse WT 餅乾類 filtered by tag「狗餅」→ /collections/餅乾類/狗餅",
  },
  {
    key: "狗狗糊仔小食",
    parentSlug: "dogs",
    pathSlug: "paste-treats",
    wtHandle: "狗狗糊仔小食",
    origin: "wt-japan",
    note: "Reuse WT 狗狗糊仔小食 → /collections/狗狗糊仔小食/狗狗糊仔小食",
  },
  {
    key: "狗芝士",
    parentSlug: "dogs",
    ...
    wtHandle: "狗芝士",
    origin: "wt-japan",
    note: "Reuse WT 狗芝士 → /collections/狗芝士/狗芝士",
  },
  {
    key: "冷凍脫水系列",
    parentSlug: "dogs",
