...
const JA_LABELS: Partial<Record<TranslationKey, string>> = {
  ...
  bulkDiscountApplied: "{percent}%割引が適用されました",
  bulkHintUnder4: "🎁 あと{count}個で5%割引！",
  bulkHint4To7: "🎉 5%割引中！あと{count}個で10%割引にアップ！",
  bulkHint8To11: "🎉 10%割引中！あと{count}個で最大15%割引を解放！",
  bulkHint12Plus: "🏆 最大15%のまとめ買い割引中。お得におすすめです！",
  bulkShortcut4: "4個 (5%OFF)", bulkShortcut8: "8個 (10%OFF)", bulkShortcut12: "12個 (15%OFF)", bulkShortcutLabel: "まとめ買いショートカット",
