...
export const translations = {
  zh: {
    ...
    brandGuide: "Mofu Haven 專題指南",
    brandGuideTitle: "探索寵物世界",
    brandGuideBody: "精選 10 多種人氣貓咪品種深入介紹，結合日系治癒風格與科學飼養小筆記，陪伴您與毛孩共度溫馨愉悅的每一天。",
    exploreCta: "立即探索",
  ...
  en: {
    ...
    brandGuide: "Mofu Haven guide",
    brandGuideTitle: "Explore the pet world",
    brandGuideBody: "Discover 10+ popular cat breeds through a gentle Japanese-inspired guide with practical care notes for warmer days with your companion.",
