...
export const translations = {
  zh: {
    ...
    shippingPostalLabel: "郵政編碼（選填）",
    shippingPostalPlaceholder: "如適用",
    shippingContactRequired: "請填寫收件人姓名、電話同送貨地址。",
  ...
  en: {
    ...
    shippingPostalLabel: "Postal code (optional)",
    shippingPostalPlaceholder: "If applicable",
    shippingContactRequired: "Please enter recipient name, phone, and shipping address.",
