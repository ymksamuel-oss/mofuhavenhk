...
export const translations = {
  zh: {
    ...
    serviceFreeShippingBody: "全店消費滿 HK$450 即享本地免運。",
    ...
    homepageGridTitle: "今期人氣寵物好物",
    homepageGridSubtitle: "由 Mofu Haven 精選的貓咪、狗狗及日系寵物用品，直接由現時產品目錄載入。",
  ...
  en: {
    ...
    serviceFreeShippingBody: "Enjoy free local shipping on orders from HK$450.",
    ...
    homepageGridTitle: "Popular Pet Picks",
    homepageGridSubtitle: "A curated selection of cat, dog, and Japanese pet essentials loaded from our live catalog.",
    ...
    badgeFeatured: "Mofu pick",
    badgeNewArrival: "New this week",
    ...
    freeOverHk450: "Free over HK$450",
