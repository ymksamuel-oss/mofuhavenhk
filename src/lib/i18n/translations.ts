...
export const translations = {
  zh: {
    ...
    currency: "HK$",
    paymentTitle: "付款方式",
    paymentHint: "Apple Pay／Google Pay 一鍵付款，或信用卡（Stripe）、FPS轉數快。",
    ...
    fpsMethodsNote: "選擇 FPS 後，請喺下方展開收款方式：查看並複製電話號碼、複製應付金額，或展開 QR Code；確認訂單後請用 WhatsApp 傳送轉帳截圖畀店主。",
    fpsPanelTitle: "FPS轉數快",
    fpsPanelHint: "請選擇收款人類別以繼續",
    fpsIdLabel: "FPS ID／電話",
    fpsAccountLabel: "收款戶口名稱",
    fpsAmountLabel: "應付金額",
    fpsOptionProxy: "手提電話號碼 / 電郵地址 / 轉數快識別碼",
    fpsOptionProxyHint: "複製下方號碼，於銀行 App 貼上完成轉帳。",
    fpsOptionAmount: "轉帳金額快速複製",
    fpsOptionAmountHint: "一鍵複製應付金額，避免手動輸入錯誤。",
    fpsOptionQr: "轉數快二維碼 (QR Code)",
    fpsOptionQrHint: "用銀行 App 掃描下方 QR Code 完成轉帳。",
    fpsCopyNumber: "複製號碼",
    fpsCopyAmount: "複製金額",
    fpsCopied: "已複製",
    fpsQrAlt: "FPS 轉數快 QR Code",
    fpsQrHint: "請用銀行 App 掃描上方 QR Code 完成轉帳。",
    ...
    fpsWhatsappScreenshot: "📷 請在此對話附上轉數快／FPS 轉帳截圖畀店主核對，多謝！",
  ...
  en: {
    ...
    navBackToMenu: "Back to product catalog",
    langZh: "中",
    langEn: "EN",
    ...
    paymentHint: "Apple Pay / Google Pay one-tap, card (Stripe), or FPS轉數快.",
    ...
    fpsMethodsNote: "After choosing FPS, expand a payee option below: view and copy the phone number, copy the amount due, or show the QR code. Then confirm and send your transfer screenshot on WhatsApp.",
    fpsPanelTitle: "FPS轉數快",
    fpsPanelHint: "Please select a payee category to continue",
    fpsIdLabel: "FPS ID / phone",
    fpsAccountLabel: "Account name",
    fpsAmountLabel: "Amount due",
    fpsOptionProxy: "Mobile number / Email / FPS identifier",
    fpsOptionProxyHint: "Copy the number below and paste it in your banking app.",
    fpsOptionAmount: "Quick-copy transfer amount",
    fpsOptionAmountHint: "Copy the amount due in one tap to avoid typos.",
    fpsOptionQr: "FPS QR Code",
    fpsOptionQrHint: "Scan the QR code below with your banking app to pay.",
    fpsCopyNumber: "Copy number",
    fpsCopyAmount: "Copy amount",
    fpsCopied: "Copied",
    fpsQrAlt: "FPS QR code",
    fpsQrHint: "Scan the QR code above with your banking app to pay.",
    ...
    fpsWhatsappScreenshot: "📷 Please attach your FPS transfer screenshot in this chat for verification. Thank you!",
    ...
    whatsappFpsHeading: "FPS payment note",
