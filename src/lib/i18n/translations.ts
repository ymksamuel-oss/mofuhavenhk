...
export const translations = {
  zh: {
    ...
    fpsMethodsNote: "選擇 FPS 後可複製收款資料或展開 QR；確認訂單後請用 WhatsApp 傳送轉帳截圖畀店主。",
    fpsPanelTitle: "FPS 轉數快收款資料",
    fpsPanelHint: "請用銀行 App 掃描 QR 或輸入以下資料完成轉帳。",
    fpsMenuTitle: "請選擇收款人類別以繼續",
    fpsMenuHint: "點擊選項即可複製資料或展開二維碼。",
    fpsOptionProxy: "手提電話號碼／電郵地址／轉數快識別碼",
    fpsOptionAmount: "轉帳金額（一鍵複製）",
    fpsOptionQr: "轉數快二維碼（QR Code）",
    fpsTapToCopy: "點擊複製",
    fpsTapToExpand: "點擊展開",
    fpsQrExpanded: "已展開 QR Code",
    fpsCopiedId: "已複製 FPS ID",
    fpsCopiedAmount: "已複製轉帳金額",
    fpsCopyFailed: "複製失敗，請手動輸入。",
  ...
  en: {
    ...
    fpsMethodsNote: "With FPS selected, copy receiving details or expand the QR, then confirm and WhatsApp your transfer screenshot to the shop.",
    ...
    fpsTapToCopy: "Tap to copy",
    fpsTapToExpand: "Tap to expand",
    fpsQrExpanded: "QR code expanded",
    fpsCopiedId: "FPS ID copied",
    fpsCopiedAmount: "Amount copied",
    fpsCopyFailed: "Could not copy — please enter it manually.",
