...
export const translations = {
  zh: {
    ...
    currency: "HK$",
    paymentTitle: "付款方式",
    paymentHint: "手機優先：Apple Pay／Google Pay 一鍵付款，或信用卡（Stripe）、SC Pay 轉數快。",
  ...
  en: {
    ...
    paymentHint: "Mobile-first: Apple Pay / Google Pay one-tap, card (Stripe), or SC Pay 轉數快.",
