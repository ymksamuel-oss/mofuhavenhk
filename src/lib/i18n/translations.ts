...
export const translations = {
  zh: {
    ...
    dogSnacksZoneSubtitle:
      "精選狗狗零食同獎勵小食，獨立歸入狗狗商品。系列沿用 WT Japan 既有資料夾：餅乾類（狗餅）、狗狗糊仔小食、狗芝士。",
    dogSnackSeriesNavLabel: "狗狗小食系列",
    dogSnackSeriesAll: "全部狗狗小食",
    dogSnackSeriesBiscuits: "餅乾類（狗餅）",
    dogSnackSeriesPaste: "狗狗糊仔小食",
    dogSnackSeriesCheese: "狗芝士",
  ...
  en: {
    ...
    catSubFreezeDried: "Cat treats / Freeze-dried series",
    ...
    dogSnacksZoneSubtitle:
      "Dog snacks and reward treats under Dog Products. Series reuse existing WT Japan folders: biscuits (狗餅), paste treats, and dog cheese.",
    dogSnackSeriesNavLabel: "Dog treat series",
    dogSnackSeriesAll: "All dog treats",
    dogSnackSeriesBiscuits: "Biscuits (狗餅)",
    dogSnackSeriesPaste: "Dog paste treats",
    dogSnackSeriesCheese: "Dog cheese",
