...
export const translations = {
  zh: {
    ...
    homeHeroEyebrow: "Mofu Haven · 寵物好物",
    homeHeroStamp: "日本寵物用品",
    homeCategoryEyebrow: "寵物類型／護理需要",
    homeCategoryIndex: "索引／08",
  ...
  en: {
    ...
    homeHeroEyebrow: "Mofu Haven · Pet essentials",
    homeHeroStamp: "Japanese pet essentials",
    homeCategoryEyebrow: "Pet type / care need",
    homeCategoryIndex: "INDEX / 08",
