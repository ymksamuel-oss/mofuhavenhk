...
export const translations = {
  zh: {
    ...
    fpsMethodsNote: "選擇 FPS 後，請喺下方揀收款方式：複製電話號碼、複製應付金額，或展開 QR Code；確認訂單後請用 WhatsApp 傳送轉帳截圖畀店主。",
  ...
  en: {
    ...
    fpsMethodsNote: "After choosing FPS, pick a payee option below: copy the phone number, copy the amount due, or expand the QR code. Then confirm and send your transfer screenshot on WhatsApp.",
    fpsPanelTitle: "SC Pay 轉數快",
