...
export const translations = {
  zh: {
    ...
    fpsPanelHint: "請用銀行 App 完成轉帳。可一鍵複製電話／金額，或儲存二維碼掃描付款。",
    fpsShortcutsTitle: "快速付款捷徑",
    fpsCopyIdAction: "手提電話號碼／FPS ID 轉帳",
    fpsCopyIdActionHint: "一鍵複製，貼上至銀行 App",
    fpsCopyAmountAction: "轉帳金額快速複製",
    fpsCopyAmountActionHint: "複製精確應付金額，避免入錯數",
    fpsQrAction: "儲存／檢視轉數快二維碼",
    fpsQrActionHint: "放大檢視或儲存到相簿",
    fpsOpenBankApp: "開啟銀行／轉數快 App",
    fpsOpenBankAppHint: "若裝置支援，會嘗試跳轉至銀行 App",
    fpsCopiedId: "已複製電話號碼／FPS ID",
  ...
  en: {
    ...
    fpsPanelHint: "Pay in your banking app — copy the phone/amount in one tap, or save the QR to scan.",
    fpsShortcutsTitle: "Quick payment shortcuts",
    fpsCopyIdAction: "Pay by mobile / FPS ID",
    fpsCopyIdActionHint: "Copy, then paste in your banking app",
    fpsCopyAmountAction: "Copy exact amount",
    fpsCopyAmountActionHint: "Paste the precise total — avoid typos",
    fpsQrAction: "Save / view FPS QR code",
    fpsQrActionHint: "Enlarge or save to your photos",
