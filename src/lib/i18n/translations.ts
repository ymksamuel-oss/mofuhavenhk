...
export const translations = {
  zh: {
    ...
    fpsPanelHint: "請先選擇付款方式，再一鍵複製資料或掃描二維碼完成轉帳。",
    fpsMethodSelectTitle: "請選擇轉帳方式",
    fpsMethodProxy: "手提電話號碼／電郵地址／轉數快識別碼",
    fpsMethodProxyHint: "複製電話／FPS ID，貼上至銀行 App",
    fpsMethodAmount: "銀行戶口號碼／轉帳金額",
    fpsMethodAmountHint: "複製精確應付金額，避免入錯數",
    fpsMethodQr: "轉數快二維碼（QR Code）",
    fpsMethodQrHint: "放大檢視或儲存，方便另一部手機掃描",
    fpsOpenBankApp: "開啟銀行／轉數快 App",
    fpsOpenBankAppHint: "若裝置支援，會嘗試跳轉至銀行 App",
    fpsCopiedId: "已複製電話號碼／轉數快識別碼",
    fpsCopiedAmount: "已複製轉帳金額",
    fpsCopyFailed: "複製失敗，請手動選取文字。",
    fpsIdLabel: "手提電話／轉數快識別碼",
    ...
    fpsQrHint: "點擊二維碼可放大；可用另一部手機掃描或儲存截圖。",
    fpsQrViewTitle: "轉數快二維碼",
    fpsQrEnlarge: "放大檢視",
    fpsQrSave: "儲存二維碼",
    fpsQrClose: "關閉",
    fpsQrSaveFailed: "未能儲存圖片，請長按二維碼手動儲存。",
  ...
  en: {
    ...
    fpsPanelHint: "Choose how you want to pay, then copy the details or scan the QR in your banking app.",
    fpsMethodSelectTitle: "Choose a transfer method",
    fpsMethodProxy: "Mobile number / email / FPS ID",
    fpsMethodProxyHint: "Copy the phone or FPS ID, then paste in your bank app",
    fpsMethodAmount: "Bank account / transfer amount",
    fpsMethodAmountHint: "Copy the exact amount due — avoid typos",
    fpsMethodQr: "FPS QR code",
    fpsMethodQrHint: "Enlarge or save so another phone can scan it",
    fpsOpenBankApp: "Open banking / FPS app",
    fpsOpenBankAppHint: "If supported, jump straight to your bank app",
    fpsCopiedId: "Mobile / FPS ID copied",
    fpsCopiedAmount: "Transfer amount copied",
    fpsCopyFailed: "Could not copy — please select the text manually.",
    fpsIdLabel: "Mobile / FPS ID",
    fpsAccountLabel: "Account name",
    fpsAmountLabel: "Amount due",
    fpsCopy: "Copy",
    fpsCopied: "Copied",
    fpsCopyAgain: "Copy again",
    fpsQrAlt: "FPS QR code",
    fpsQrHint: "Tap the QR to enlarge — scan with another phone or save a screenshot.",
    fpsQrViewTitle: "FPS QR code",
    fpsQrEnlarge: "Enlarge",
    fpsQrSave: "Save QR code",
    fpsQrClose: "Close",
    fpsQrSaveFailed: "Could not save the image — long-press the QR to save it.",
