...
export const translations = {
  zh: {
    ...
    fpsMethodsNote: "選擇 FPS 後，右側訂單欄會顯示銀行 App 風格收款選單（複製號碼／金額或掃描 QR）；確認訂單後請用 WhatsApp 傳送轉帳截圖畀店主。",
  ...
  en: {
    ...
    fpsMethodsNote: "After choosing FPS, use the bank-app style payee menu in the order column to copy the number/amount or scan the QR. Then confirm and send your transfer screenshot on WhatsApp.",
    fpsPanelTitle: "FPS (轉數快)",
