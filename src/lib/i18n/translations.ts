...
export const translations = {
  zh: {
    ...
    fpsMethodsNote: "選擇 FPS 後，請揀收款方式複製號碼／金額或掃描 QR；確認訂單後請用 WhatsApp 傳送轉帳截圖畀店主。",
  ...
  en: {
    ...
    fpsMethodsNote: "After choosing FPS, pick a payee option to copy the number/amount or scan the QR. Then confirm and send your transfer screenshot on WhatsApp.",
    fpsPanelTitle: "FPS (轉數快)",
