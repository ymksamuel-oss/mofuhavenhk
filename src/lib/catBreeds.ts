...
/** Maine Coon rich profile for `/cat-breeds/maine-coon`. */
...
/** Scottish Fold rich profile for `/cat-breeds/scottish-fold`. */
...
/** Siamese rich profile for `/cat-breeds/siamese`. */
...
/** Bengal rich profile for `/cat-breeds/bengal`. */
...
/** Sphynx rich profile for `/cat-breeds/sphynx`. */
...
/** Devon Rex rich profile for `/cat-breeds/devon-rex`. */
...
/** Domestic / HK mix shorthair rich profile for `/cat-breeds/mix-shorthair`. */
