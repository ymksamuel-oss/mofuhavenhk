 ...
 */
/**
 * Complete product entries restored from the last full catalog revision.
 * Kept separate so all current products remain intact and no ID is overwritten.
 */
const RESTORED_HISTORICAL_PRODUCTS: Product[] = [
    {
