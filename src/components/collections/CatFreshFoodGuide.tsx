      ...
      <section className="relative isolate px-4 pb-10 pt-5 sm:px-6 sm:pb-16 sm:pt-10 lg:px-10">
        <div className="mx-auto grid max-w-6xl items-center gap-7 overflow-hidden rounded-[2rem] bg-[#ead8c7] px-5 py-7 shadow-[0_24px_65px_-42px_rgba(80,52,35,0.65)] sm:px-10 sm:py-12 lg:grid-cols-[1.02fr_0.98fr] lg:gap-10 lg:px-14">
          <div className="relative z-10">
            ...
            <h1 className="max-w-xl text-[2.2rem] font-semibold leading-[1.12] tracking-[-0.04em] text-[#3d2d25] sm:text-5xl lg:text-6xl">貓咪專屬<br />日系和風鮮食</h1>
            ...
            <div className="mt-7 flex flex-wrap gap-2 text-xs font-medium text-[#76513c]"><span className="rounded-full bg-[#fffaf4]/70 px-3 py-1.5">日本國產</span><span className="rounded-full bg-[#fffaf4]/70 px-3 py-1.5">無添加</span></div>
          </div>
          <div className="relative mx-auto aspect-square w-full max-w-[28rem] overflow-hidden rounded-[1.6rem] bg-[#f8eee4] shadow-[0_18px_40px_-28px_rgba(55,36,25,0.65)]">
            ...
            <div className="absolute bottom-4 left-4 rounded-2xl bg-[#fffaf4]/90 px-3.5 py-2 text-xs font-semibold text-[#694938] shadow-sm">100% 日本國產</div>
          </div>
        </div>
      </section>
