 ...
 * Usage: node scripts/audit_stripe_product_skus.mjs <output.json>
 */
...
if (!outputPath) throw new Error("Usage: node scripts/audit_stripe_product_skus.mjs <output.json>");
