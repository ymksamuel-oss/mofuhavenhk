  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        <HeroBanner />
        <section aria-labelledby="pet-world-banner" className="group relative overflow-hidden bg-[#F3E5D5] py-5 md:py-8 border-y border-[#D3A87C]/25 shadow-sm transition-transform duration-300 hover:-translate-y-1 hover:scale-[1.01] hover:shadow-[0_16px_36px_rgba(140,107,83,0.18)] motion-reduce:transition-none motion-reduce:hover:transform-none">
