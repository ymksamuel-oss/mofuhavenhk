...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      <SheetContent side="right" className="w-full max-h-[100vh] overflow-y-auto !overflow-y-auto [-webkit-overflow-scrolling:touch] [touch-action:pan-y] border-[#B88A58]/25 bg-[#FFFDF9] sm:max-w-md pb-20">
