    ...
    <header className="sticky top-0 z-50 border-b border-border bg-white/95 shadow-sm backdrop-blur-md">
      <div className="container flex h-32 items-center justify-between">
        <a href="/" aria-label="Mofu Haven 首頁" className="group flex min-w-0 items-center">
          <img src="/manus-storage/mofu-haven-logo-transparent_20d068b4.png" alt="Mofu Haven" className="h-[110px] max-h-[120px] w-auto object-contain transition-transform duration-300 group-hover:scale-[1.02]" />
        </a>
