...
describe("pet world real photos and multi-image carousel", () => {
  ...
  it("includes multi-image carousel container and pagination dots in PetWorld.tsx", () => {
    ...
    expect(petWorldCode).toContain("horizontal-scroll flex aspect-[4/3] w-full snap-x snap-mandatory overflow-x-auto");
    expect(petWorldCode).toContain("images.length > 1");
