#!/usr/bin/env python3
"""
Scrape cat freeze-dried treats from WT Japan (冷凍脫水系列).

Primary source: Shopify native JSON endpoint
  https://www.wt-japan.com/collections/冷凍脫水系列/products.json

Downloads hero images into public/images/products/wt-freeze-dried-N.jpg
and prints a JSON summary for curating src/data/productsData.ts.
"""
...
SUMMARY_OUT = ROOT / "scripts" / "wt_freeze_dried_raw.json"
...
# Retail-friendly cat SKUs (skip bulk 150g×15 / HKD 2500+ cartons).
CURATED_HANDLES: list[str] = [
    "但馬高原冷凍脫水雞條-30g-x-10袋",
    "但馬高原-冷凍脫水雞胸肉-雞肝-貓貓用-20g-x-10袋",
    "但馬高原冷凍日本國產帆立貝貓貓用-30g-x-10袋",
    "但馬高原-冷凍脫水銀魚貓貓用-13g-x-10袋",
    "但馬高原冷凍日本國產虹鮭魚貓貓用-17g-x-10袋",
    "但馬高原-冷凍脫水雞胸肉-雞腎-貓貓用-20g-x-10袋-1",
    "mamacook-但馬高原冷凍日本國產金槍魚貓貓用-14g-x-10袋",
    "但馬高原冷凍脫水雞柳貓貓用-30g-x-10袋",
    "mamacook-但馬高原冷凍脫水雞粒貓貓用-18g-x-10袋",
    "但馬高原-冷凍脫水豬心貓貓用-25g-x-10袋",
    "但馬高原-冷凍脫水無添加豬大腿肉貓貓用-20g-x10",
    "mamacook-但馬高原冷凍日本國產信州三文魚貓貓用-17g-x-10袋",
    "貓貓零食-petio-冷凍脫水系列-三文魚-10g-x-6",
    "貓貓零食-petio-冷凍脫水系列-雞肉-雞肝-雞腎-15g-x-6",
    "貓貓零食-petio-冷凍脫水系列-金槍魚-鰹魚-三文魚9g-x-6",
    "mamacook-但馬高原-冷凍脫水西太公魚貓貓用-10g-x-10袋",
    "貓貓小食-日本國產無添加冷凍脫水雞肝貓貓用-40g-x-8",
    "貓貓小食-日本國產無添加冷凍脫水雞肉貓貓用-40g-x-8",
]
...
def normalize_product(raw: dict[str, Any], index: int) -> dict[str, Any]:
    ...
    filename = f"wt-freeze-dried-{index}.jpg"
    return {
        "id": f"wt-freeze-dried-{index}",
        "title": title,
        "price": price,
